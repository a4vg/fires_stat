...
reqpackages <- c("prettydoc", "plyr", "dplyr","ggplot2")
...
ggplot() + geom_line(data=df_2010, aes(x=cause, y=perc, group=1, colour="2010"))  +
  geom_line(data=df_2012, aes(x=cause, y=perc, group=1, colour="2012")) +
  geom_line(data=df_2014, aes(x=cause, y=perc, group=1, colour="2014")) +
  scale_x_continuous("Cause code", labels = causes, breaks = xrange) +
  scale_y_continuous("Percentage") +
  scale_colour_manual("", breaks=c("2010","2012","2014"), values=c("red", "green", "blue")) +
