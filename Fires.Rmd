...
g_2010 <- formatdate(file="data/GenIn2010_gourmet.csv", T)
g_2012 <- formatdate(file="data/GenIn2012_gourmet.csv", T)
g_2014 <- formatdate(file="data/GenIn2014_gourmet.csv", T)
