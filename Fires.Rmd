...
reqpackages <- c("prettydoc", "plyr", "dplyr","prettydoc")
...
# Upload csv
causes_2010 <- formatdate(file="data/Causes2010_cleaned.csv")
causes_2012 <- formatdate(file="data/Causes2012_cleaned.csv")
causes_2014 <- formatdate(file="data/Causes2014_cleaned.csv")

# Initialize causes
causes <- seq(16)
causes[1] <- "Exposure"
causes[2] <- "Intentional"
causes[3] <- "Investigation with Arson Module"
causes[4] <- "Playing with Heat Source"
causes[5] <- "Natural"
causes[6] <- "Other Heat"
causes[7] <- "Smoking"
causes[8] <- "Heating"
causes[9] <- "Cooking"
causes[10] <- "Appliances"
causes[12] <- "Electrical Malfunction"
causes[13] <- "Open Flame, Spark (heat from)"
causes[14] <- "Other Unintentional, Careless"
causes[15] <- "Equipment Misoperation, Failure"
causes[16] <- "Unknown"
