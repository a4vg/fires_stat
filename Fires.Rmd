...
<div>
*Conclusión*: Se rechaza la hipótesis nula, ya que p-value vale 2.2e-16 y nuestro alfa es 0.05. Podemos ver que p-value es menor y que el pronedio de los incendios  es a las 1:40 aproximadamente.
</div>
...
<div>
*Conclusión*: Se rechaza la hipotesis nula, ya que p-value vale 1.011e-05 y nuestro alfa es 0.05. Podemos ver que p-value es menor  y la verdadera media es 17.27185
</div>
...
Primero se separan las cantidades de incendios por fechas de las 4 estaciones. Luego  se  hace una grafica comparando  la cantidad de  incendios de cada uno.
